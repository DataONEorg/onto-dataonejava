...
public class MyOwlOntologyManager {
	...
	public MyOwlOntologyManager(){
		
	}
	
	
	public static void main(String[] args){
		MyOwlOntologyManager owl = new MyOwlOntologyManager();
		try {
...
//        manager.saveOntology(ontology, IRI.create(file.toURI()));   //uses...some type of RDF format, but not the same as SWEET
	...
	public OWLClass getClassFromName(OWLOntologyManager manager, String name) throws IOException{
		OWLOntology ontology = manager.getOntology(currentOntologyID);
		for (OWLClass cls : ontology.getClassesInSignature()){
